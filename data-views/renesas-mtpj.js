...
const { autoCompleteGeneratedS19 } = require("./srecord_reformat")
// ─────────────────────────────────────────────────────────────
// State
// ─────────────────────────────────────────────────────────────
...
const buildProject = async (element) => {
  ...
  const cmake_extension = vscode.extensions.getExtension('ms-vscode.cmake-tools')
  const buildAftergenr = vscode.workspace.getConfiguration('renesas').get('genrpostbuild')
  const formatAftergenr = vscode.workspace.getConfiguration('renesas').get('formatpostbuild')
  const clearbuild = vscode.workspace.getConfiguration('renesas').get('clearbuild')
